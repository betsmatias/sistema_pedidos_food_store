...
public class Producto extends Base {
    ...
    private Categoria categoria; // Relación con la clase Categoría
    ...
    public String toString() {
        // Mostramos solo el nombre de la categoría para no sobrecargar la consola
        String nombreCat = (categoria != null) ? categoria.getNombre() : "Sin categoría";
        return "ID: " + getId() + " | " + nombre + " | Precio: $" + precio + " | Stock: " + stock + " | Cat: " + nombreCat;
    }
}